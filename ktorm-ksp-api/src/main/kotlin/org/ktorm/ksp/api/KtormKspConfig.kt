...
public annotation class ExtensionGenerator(
    ...
    /**
     * Generate constructor function, componentN function, copy function. Generated only for interface entity.
     *
     ...
     * dynamic proxy object, dynamically generate bytecode object, object created by Unsafe（It depends on what the
     * specific type is）This generated instance is unique and will not conflict with the parameters passed when
     * calling（Unless you also call the [Undefined.of] function to get the instance）Therefore, it can help us determine
